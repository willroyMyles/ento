...
class ConfigureCompanyView extends StatelessWidget {
  ...
  ConfigureCompanyView({Key? key, this.shouldSkip = false}) : super(key: key);
  final controller = Get.put(ConfigureCompanyState());

  @override
  Widget build(BuildContext context) {
    // controller.setShouldSkip(shouldSkip);
    return Scaffold(
      body: GetBuilder<ConfigureCompanyState>(initState: (state) {
        print(" when is this called? $state");
        controller.setShouldSkip(shouldSkip);
      }, builder: (context) {
        return Stack(
          children: [
